const Information = () => {
  return (
    <>
      <div className="h-[400px] md:-mt-60 w-full bg-project-page-mobile-wave md:bg-project-page-wave bg-no-repeat bg-cover md:h-[1000px] md:pt-[10px]">
        <div className="flex flex-col items-center text-white md:pt-[500px] pt-10">
