...
const NavBar = () => {
  ...
  return (
    <div className="xxxxl:w-[1440px] xxxxl:mx-auto px-2 lg:px-4 sm:px-12 py-1 flex justify-between  items-center bg-gpgp-blue sm:bg-white xxxxl:max-w-[2560px] xxxxl:mx-auto">
