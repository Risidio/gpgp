    ...
    <>
      <div className="h-[413px] w-[100%] bg-project-page-mobile-wave md:bg-project-page-wave bg-no-repeat bg-cover md:h-[1208.5px] md:pt-[395px]">
        <div className="flex flex-col items-center text-white">
          <h1 className="mt-[80px] md:mt-[130px] uppercase leading-[23px] md:leading-[48px] text-bold text-2xl">
             About the Project
          </h1>
          <p className="mt-[10px] md:mt-[25px] text-[12px] text-center md:text-[17px] leading-[21px] md:leading-[32px] font-[400] sm:text-[1rem] sm:w-[50%] w-[75%]">
