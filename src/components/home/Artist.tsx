...
const Artist = ({contents}:IHomeArtistProp) => {
  return (
    <Wrapper>
      <div
        className={`flex flex-col justify-center items-center max-w-[289px] lg:max-w-[522px] mx-auto`}
      >
        ...
        <div className="flex flex-col text-[#050B1D]  text-center font-[be-vietnam]">
