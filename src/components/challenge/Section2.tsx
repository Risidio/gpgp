    ...
    <>
      <div className="">
        ...
        <div className="grid md:grid-cols-2 md:border-y-[1px] md:border-gpgp-blue">
          <div className="w-full h-[200px] md:h-[602px] order-1 bg-[length:100%_100%] bg-trashed-plastics md:bg-none md:border-y-[0px] border-gpgp-blue">
            <img
              src={TrashedPlasticObjects}
              className="hidden md:block w-full h-full md:w-[740px] md:h-[100%]"
