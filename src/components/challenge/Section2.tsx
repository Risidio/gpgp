...
const Section2 = () => {
  return (
    <>
      <div className="pb-[0px] md:pb-none  mt-[unset] md:mt-[360px]">
        {/* <div className="grid md:grid-cols-2 md:w-[1440px] md:mx-auto gap-[unset] md:gap-[128px] bg-yellow-500"> */}
        <div className="flex flex-col md:flex-row md:w-[1440px] md:mx-auto gap-[unset] md:gap-[128px] justify-center">
          ...
          <div className="order-2 flex flex-col md:w-[556px]  md:mx-auto xxl:mx-0">
            <div className="hidden md:block xxl:block md:w-[556px]  md:mt-[0px]">
              <h1 className="text-[#050B1D] font-[be-vietnam-bold] md:text-4xl text-center md:text-left font-bold leading-[147.51%]">
            ...
            <div className="flex flex-col w-[293px] md:w-[523px] mx-auto md:mx-[unset] justify-center items-center gap-y-[20px] mt-[30px] md:mt-[52px]">
              ...
              <p className="text-center xxl:text-left text-[#050B1D] font-[be-vietnam] text-[15px] md:text-[16px] lg:text-[16px] xl:text-[20px] xxxl:text-[25px] leading-[200%] md:leading-[200%] lg:leading-[200%] xl:leading-[40px] sm:leading-[30px] font-[500]">
