    ...
    <>
      <div className="flex flex-col items-center md:pb-[200px]">
        <div className="w-[293px] md:w-[1440px]  md:px-none py-[35px] md:py-none md:mt-[150px] flex flex-col items-center gap-y-[20px] md:gap-y-[65px]">
          ...
          <p className="md:w-[1081px] text-center text-[#050B1D] font-[be-vietnam] text-[15px] md:text-4xl lg:text-[22px] xl:text-[24px] xxl:text-[25px] xxxxl:text-[35px] md:font-bold leading-[200%] tracking-[-0.9px]">
