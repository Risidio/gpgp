    ...
    <>
      ...
      <section className="mt-[82.5px] xl:mt-[211px]">
        <div className="grid text-center text-[16px] leading-[32px] tracking-[-0.32px] font-[be-vietnam] bold-400">
          ...
          <div className="w-[293px] xl:w-[698px] mx-auto xl:order-2 mt-[31px] xl:mt-[75px] h-[4px] xl:h-[10px] bg-gpgp-blue rounded-[40px] w-[297px]"></div>

          <h3 className="mt-[29px] xl:mt-0 w-[293px] xl:w-[697px] mx-auto">
