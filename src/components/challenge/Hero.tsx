    ...
    <>
      <div className="w-[100%] border-y-[4px] bg-[length:100%_100%] bg-flat-lay-assortment md:bg-none md:border-y-[0px] border-gpgp-blue">
        ...
        <div className="w-full bg-white md:bg-blue-plastic-bag md:bg-no-repeat bg-[length:100%] md:bg-[length:100%_790px] backdrop-blur-md">
          <div className="w-full flex flex-col items-center gap-y-[20px] md:gap-y-[60px] px-[23px] md:px-[150px] xxxl:px-[300px] xxxxl:px-[600px] pt-[35px] md:pt-[21px] pb-[40px] md:pb-[171px]">
            <p className="text-center text-[#050B1D] font-be-vietnam md:text-base text-[16px] md:text-[21.5px] xxl:text-[25px] xxxxl:text-[35px] md:font-medium leading-[200%] md:leading-[30px] xxl:leading-[40px] xxxxl:leading-[50px] tracking-[-0.4px]">
            ...
            <p className="text-center text-[#050B1D] font-be-vietnam md:text-base text-[16px] md:text-[21.5px] xxl:text-[25px] xxxxl:text-[35px] md:font-medium leading-[200%] md:leading-[30px] xxl:leading-[40px] xxxxl:leading-[50px] tracking-[-0.32px]">
            ...
            <p className="text-center text-[#050B1D] text-[16px] md:text-[21.5px] xxl:text-[25px] xxxxl:text-[35px] font-be-vietnam md:text-base md:font-medium leading-[200%] md:leading-[30px] xxl:leading-[40px] xxxxl:leading-[50px] tracking-[-0.32px]">
