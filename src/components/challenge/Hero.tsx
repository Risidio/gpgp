  ...
  return (
    <>
      <div className="w-[100%] border-y-[4px] bg-[length:100%_100%] bg-flat-lay-assortment md:bg-none md:border-y-[0px] border-gpgp-blue">
        <div className="md:hidden w-[100%] md:bg-[white] py-[70px] md:py-none px-[40px] md:px-none md:p-none text-center">
        ...
        <div className="w-full bg-h-[100%] bg-w-[100%] bg-white md:bg-project-page-wave md:bg-no-repeat bg-no-repeat bg-cover md:pt-[140px]">
