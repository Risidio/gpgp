  ...
  return (
    <>
      ...
      <div className="w-[100%] border-y-[4px] bg-[length:100%_100%] md:bg-none md:border-y-[0px] border-gpgp-blue lg:mt-[34px]">
        ...
        <div className="w-full flex flex-col uppercase font-[be-vietnam-semibold] leading-[40px] md:leading-[70px] lg:leading-[100px]">
          <div className="text-[32px] md:text-[50px] lg:text-[80px] text-center md:text-left lg:pl-[80px] text-[#0A2471] ">The art inspiring</div>
          <div className="text-[32px] md:text-[50px] lg:text-[80px] text-center md:text-left lg:pl-[80px]">global action</div>
        </div>
        </div>
        ...
        <div className="w-full md:w-1/2 md:block flex flex-col justify-center items-center order-last md:order-first mt-[17px]">
          ...
          <div className="w-full mt-[29px] lg:mt-[14px]">
            <button className="flex flex-col justify-center w-full h-[63px] text-[16px] uppercase border border-1 border-[#0A2471] rounded-[5px] font-[be-vietnam-semibold] text-[#0A2471] tracking-[5px]"><span className="mx-auto">contribute</span> <span className="mx-auto block md:hidden">as an investors</span></button>
            <button className="hidden md:block w-full h-[63px] text-[16px] uppercase border border-1 border-[#0A2471] rounded-[5px] font-[be-vietnam-semibold] text-white tracking-[5px] bg-[#0A2471] mt-[12px]">contact us</button>
            <button className="block md:hidden w-full h-[63px] flex flex-col justify-center text-[16px] uppercase border border-1 border-[#0A2471] rounded-[5px] font-[be-vietnam-semibold] text-white tracking-[5px] bg-[#0A2471] mt-[12px]"><span className="mx-auto">contribute</span> <span className="mx-auto">as an artist</span></button>
          </div>
        </div>
        </div>
        <div className="w-[100%] mt-[20px] bg-h-[100%] bg-w-[100%] bg-white bg-project-page-wave bg-no-repeat bg-no-repeat bg-cover pt-[140px]">
