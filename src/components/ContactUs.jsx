...
const ContactUs = () => {
  return (
    <div className="hidden md:block w-full bg-h-[100%] bg-w-[100%] bg-project-page-mobile-wave lg:bg-project-page-wave bg-no-repeat bg-cover md:pb-[70px] xl:pb-[80px]">
     <Wrapper>
     <div className="flex flex-col items-center text-white pt-[260px] xl:pt-[400px]">
        ...
        <div className="text-center py-3  mt-3 sm:mb-[9px]">
          <p className="text-[16px] xl:text-[44px] font-[600]">
            We’d love to hear from{" "}
            <span className="text-[#D9BF4F] underline">you</span>
          </p>
        </div>
        <div className="text-center pt-3 z-40 sm:pt-1 px-[10px] text-[16px] md:w-max leading-[22px] lg:leading-[35px] xl:leading-[40px] sm:leading-[30px] md:leading-[32px] bg-gpgp-blue mb-[-35px] font-[be-vietnam-semibold">
        ...
        <div className="flex items-center flex-col w-[89%] lg:w-[67%] md:border-2 rounded-[12px] md:mx-5 px-[50px] my-5 ">
          <div className="flex w-full justify-between sm:flex-row flex-col sm:space-x-5 pt-8 lg:pt-7 py-5">
            <div className="w-full">
              <div className="text-white font-[be-vietnam] text-[16px] leading-[22px] lg:leading-[35px] xl:leading-[40px] sm:leading-[30px] md:leading-[32px] font-[400]">
                Name
              </div>
              <Input />
            </div>
