...
const Hero = () => {
  return (
    <>
      ...
      <div className="px-[0px] md:px-[10px] lg:px-[30px] xl:px-[40px] xxl:px-[60px] xxxl:px-[70px]">
        <div className="md:flex hidden w-full m-0 px-[64.5px] xxxl:px-[0px] xxxxl:justify-center xxxxl:items-center md:px-[20px] pb-[20px]">
          <div className="flex flex-col uppercase xl:px-0 sm:px-5">
            <h1 className="text-[40px] md:text-[20px] lg:text-[30px] xl:text-[35px] xxl:text-[40px] xxxl:text-[60px] font-[be-vietnam-xbold]">
              The great pacific garbage patch art project
            </h1>
            <h2 className="text-[24px] md:text-[18px] lg:text-[22px] xl:text-[25px] xxl:text-[30px] xxxl:text-[50px] font-[be-vietnam-semibold]">
              Environmental artist john dahlsen & infinart
            </h2>
            <div className="flex flex-row">
              <div className="w-[30%] lg:w-[50%] md:w-[25%] flex flex-col">
                <h4 className="text-[24px] md:text-[18px] lg:text-[20px] xl:text-[22px] xxl:text-[24px] xxxl:text-[40px] font-[be-vietnam-semibold] my-auto">
                  The art inspiring global action
                </h4>
                <div className="flex justify-start gap-x-2 xxxl:gap-x-4">
                  <MyLink
                    to="/gallery"
                    className="uppercase w-44 py-2 xxl:py-[15px] xxxl:py-[30px] xxxxl:py-[40px] xxxl:w-[450px]"
                  >
                    <p className="lg:text-[20px] xxxxl:text-[30px] xxxl:tracking-[10px]">gallery</p>
                  </MyLink>
                  <MyLink
                    to="/contribute"
                    className="uppercase py-2 w-44 bg-gpgp-blue text-white hover:bg-white hover:text-gpgp-blue xxxxl:py-[30px] xxxl:w-[450px]"
                  >
                    <p className="lg:text-[20px] xxxxl:text-[30px] xxxl:tracking-[10px]">join us</p>
                  </MyLink>
                </div>
              </div>

              <div className="w-full flex items-center pl-[71px] sm:pl-[100px] md:pl-[40px] lg:pl-[50px] xl:pl-[100px] xxl:pl-[180px] xxxl:pl-[140px] xxxxl:pl-[200px]">
                <img
                  src={gpgpMapImage}
                  alt={"GPGP Map"}
                  className="sm:h-[300px] w-[1280px] md:w-[1200px] xxl:w-[700px] xxxl:w-[1700px] xxxxl:w-[2550px]  h-[459px] md:h-[300px] xxl:h-[400px] xxxl:h-[600px] xxxxl:h-[700px] xxxl:object-contain mx-auto"
                />
              </div>
            </div>
          </div>
