          ...
          <div className="order-2 md:order-1 xxxxl:flex xxxxl:flex-col xxxxl:justify-center">
            ...
            <div className="w-[100%] md:py-[50px] px-[30px] flex flex-col gap-y-[30px]">
              ...
              <p
                ...
                className="md:hidden font-[be-vietnam] text-center md:text-left text-[16px] xl:text-[20px] xxxl:text-[25px] leading-[200%] md:leading-[22px] lg:leading-[35px] xl:leading-[40px] sm:leading-[30px] md:leading-[32px] font-[400]"
              ></p>
