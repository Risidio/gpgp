      ...
      <div className="w-[100%] h-[100%] mt-[30px] md:mt-[0px]">
        ...
        <div className="w-[100%] grid md:grid-cols-2 mt-[15px] md:mt-[70px]">
          <div className="order-2 md:order-1">
            ...
            <div className="w-[100%] mt-[50px] md:mt-[0px] md:py-[60px] px-[15px] md:px-[80px] flex flex-col gap-y-[40px]">
              ...
              <div className="flex mx-auto md:mx-[0px] gap-x-[30px]">
                ...
                >
                  <p className="font-[be-vietnam] text-gpgp-blue text-[15px] md:text-[16px]">
