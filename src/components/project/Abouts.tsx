  ...
  return (
    <>
      <div className="bg-h-[100%] bg-w-[100%] bg-project-page-mobile-wave lg:bg-project-page-wave bg-no-repeat bg-cover md:pb-[50px] xl:pb-[80px] xxxl:pb-[80px]">
        <div className="flex flex-col text-white pt-[125px] md:pt-[200px] lg:pt-[300px] xl:pt-[360px] xxl:pt-[350px] xxxl:pt-[400px] xxxxl:pt-[600px]">
          ...
          <div className="mb-[80px] md:mb-[15px] lg:mb-[20px] mt-[20px] lg:mt-[50px] xxxl:mt-[60px] xl:mt-[30px] px-[39px] sm:px-[39px] md:px-[150px] lg:px-[210px] xl:px-[380px] xxxl:px-[400px] xxxxl:px-[700px]">
