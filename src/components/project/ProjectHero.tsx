...
const ProjectHero = () => {
  return (
    <>
      <div className="sm:flex w-[100%] sm:bg-[length:316px_194px] z-[2] md:bg-hero-back bg-no-repeat bg-center md:bg-[length:880px_600px]">
        <div className="h-[100%] w-[100%]">
        <div className="flex flex-col w-[100%] items-center justify-center md:h-[556px] md:w-[1194px] mx-auto uppercase font-[700] md:leading-[59px] md:text-[40px]">
